...
export default function Skills() {
  ...
  return (
    <section id="skills" ref={ref} className="relative py-16 sm:py-32 lg:min-h-screen lg:flex lg:items-center">
          ...
          {skills.map((skill, i) => {
            ...
            return (
              <motion.div
                ...
                className="group rounded-2xl sm:rounded-3xl border border-card-border bg-card-bg p-4 sm:p-6 hover:border-[#FF7A00]/20 hover:bg-[#FF7A00]/[0.02] hover:-translate-y-1 transition-all duration-500"
              >
                <div className="flex items-start justify-between gap-2 sm:gap-3 mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-icon-bg border border-icon-border flex items-center justify-center group-hover:bg-[#FF7A00]/10 group-hover:border-[#FF7A00]/20 transition-all duration-500">
                    <Icon
                      size={18}
                      className="text-fg-muted group-hover:text-[#FF7A00] transition-colors duration-500 sm:w-[22px] sm:h-[22px]"
                    />
                  </div>
                  <span
                    className={`text-[9px] sm:text-xs font-bold px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full border ${
